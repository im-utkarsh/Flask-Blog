...
def register():
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash(
            f"Account created for {form.username.data}! Please log in to continue.",
            "success",
        )
...
def new_post():
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for("home"))
    return render_template("create_update_post.html", title="New Post", form=form)
...
def update_post(post_id):
    ...
    return render_template(
        "create_update_post.html", title="Update Post", form=form, legend="Update Post"
    )
...
def reset_request():
    ...
    if form.validate_on_submit():
        ...
        flash("Password reset email!", "info")
        return redirect(url_for("login"))
